      ...
      <KeyboardAvoidingView>
        ...
        <View style={styles.general}>
          ...
          <View>
            ...
            >
              <Text style={styles.agregarButtonText}>AGREGAR CULTIVO</Text>
            </TouchableOpacity>
          </View>
          <KeyboardAwareScrollView>
            {cultivos.length > 0 ? (
              cultivos.map((cultivo) => (
                <View key={cultivo._id} style={styles.invernaderosContenedor}>
                  <View style={styles.nombreInvernadero}>
                    <Text style={styles.nombre}>{cultivo.cultivo}</Text>
                  </View>
                  <TouchableOpacity
                    onPress={() =>
                      router.push(`/(tabs)/updatescreen?cultivoId=${cultivo._id}`)
                    }
                  >
                    <Ionicons
                      style={{ marginLeft: 8 }}
