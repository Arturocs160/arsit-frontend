 ...
 return (
      <View style={styles.container}>
        ...
        <View style={styles.general}>
          ...
          <View> 
            <View><Text style={styles.titulo}>Agregar</Text></View>  
            <View style={styles.contenedor}>
             <TouchableOpacity onPress={() => router.push("/tabs)/addsensorscreen")}><Text style={styles.texto}>Sensor</Text></TouchableOpacity> 
            </View>
            <View  style={styles.contenedor}>
            <TouchableOpacity onPress={() => router.push("/(tabs)/addinvernaderoscreen")}><Text style={styles.texto}>Invernadero</Text></TouchableOpacity>             </View>
            <View  style={styles.contenedor}>
            <TouchableOpacity onPress={() => router.push("/(tabs)/addcultivoscreen")}><Text style={styles.texto}>Cultivo</Text></TouchableOpacity>             </View>
          </View>
        </View>
